...
public class DataStore {
    ...
    public Connection tscconnect() {
        Connection conn = null;
        try {
            String myDriver = "org.gjt.mm.mysql.Driver";
            String myUrl = "jdbc:mysql://localhost/tscBulk";
    ...
    public void tscinsert(String insert) {
        conn = tscconnect();
        PreparedStatement pstm = null;
        try {
            ...
            Logger.getLogger(DataStore.class.getName()).log(Level.SEVERE, "Error Updating TSC Delivery Status" + ex);
        } finally {
        }
