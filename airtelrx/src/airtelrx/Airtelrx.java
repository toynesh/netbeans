...
public class Airtelrx {
    ...
    static public void main(String[] args) throws Exception {
        ...
        config0.setSystemId("PDSLKeT");
        config0.setPassword("pdsl@996");
        ...
        try {
            ...
            t.schedule(new TimerTask() {
                ...
                public void run() {
                    try {
                        ...
                        //Logger.getLogger(Airtelrx.class.getName()).log(Level.SEVERE,
                        EnquireLinkResp enquireLinkResp1 = session0.enquireLink(new EnquireLink(), 10000);
                        Logger.getLogger(Airtelrx.class.getName()).log(Level.INFO, "enquire_link_resp #1: commandStatus [" + enquireLinkResp1.getCommandStatus() + "=" + enquireLinkResp1.getResultMessage() + "]");
                        if (session0 == null) {
                        ...
                        if (!future0.await()) {
                            Logger.getLogger(Airtelrx.class.getName()).log(Level.SEVERE,"Failed to receive enquire_link_resp within specified time");
                        } else if (future0.isSuccess()) {
                            EnquireLinkResp enquireLinkResp2 = (EnquireLinkResp) future0.getResponse();
                            Logger.getLogger(Airtelrx.class.getName()).log(Level.INFO,"enquire_link_resp #2: commandStatus [" + enquireLinkResp2.getCommandStatus() + "=" + enquireLinkResp2.getResultMessage() + "]");
                        } else {
                            Logger.getLogger(Airtelrx.class.getName()).log(Level.SEVERE,"Failed to properly receive enquire_link_resp: " + future0.getCause());
                        }*/
                    } catch (RecoverablePduException ex) {
                        java.util.logging.Logger.getLogger(Airtelrx.class.getName()).log(Level.SEVERE, null, ex);
                ...
                try {
                    ...
                    while (rs.next()) {
                        ...
                        String text160 = snd_txt;
                         Logger.getLogger(Airtelrx.class.getName()).log(Level.INFO, "From:" + snd_sender + " To:" + snd_to + " Message:" + text160);
                        ...
                        Logger.getLogger(Airtelrx.class.getName()).log(Level.INFO, "sendWindow.size: {}", session0.getSendWindow().getSize());
                        Logger.getLogger(Airtelrx.class.getName()).log(Level.INFO, "SubmitSmResp: "+submitResp);
            ...
            Logger.getLogger(Airtelrx.class.getName()).log(Level.SEVERE, "", e);
        }

        if (session0!= null) {
            Logger.getLogger(Airtelrx.class.getName()).log(Level.INFO, "Cleaning up session... (final counters)");
            if (session0.hasCounters()) {
                Logger.getLogger(Airtelrx.class.getName()).log(Level.INFO, "tx-enquireLink: {}", session0.getCounters().getTxEnquireLink());
                Logger.getLogger(Airtelrx.class.getName()).log(Level.INFO, "tx-submitSM: {}", session0.getCounters().getTxSubmitSM());
                Logger.getLogger(Airtelrx.class.getName()).log(Level.INFO, "tx-deliverSM: {}", session0.getCounters().getTxDeliverSM());
                Logger.getLogger(Airtelrx.class.getName()).log(Level.INFO, "tx-dataSM: {}", session0.getCounters().getTxDataSM());
                Logger.getLogger(Airtelrx.class.getName()).log(Level.INFO, "rx-enquireLink: {}", session0.getCounters().getRxEnquireLink());
                Logger.getLogger(Airtelrx.class.getName()).log(Level.INFO, "rx-submitSM: {}", session0.getCounters().getRxSubmitSM());
                Logger.getLogger(Airtelrx.class.getName()).log(Level.INFO, "rx-deliverSM: {}", session0.getCounters().getRxDeliverSM());
                Logger.getLogger(Airtelrx.class.getName()).log(Level.INFO, "rx-dataSM: {}", session0.getCounters().getRxDataSM());
            }
        ...
        Logger.getLogger(Airtelrx.class
                .getName()
    ...
    public static class ClientSmppSessionHandler extends DefaultSmppSessionHandler {
        ...
        public void firePduRequestExpired(PduRequest pduRequest) {
            Logger.getLogger(Airtelrx.class.getName()).log(Level.SEVERE, "PDU request expired: {}", pduRequest);
        }
