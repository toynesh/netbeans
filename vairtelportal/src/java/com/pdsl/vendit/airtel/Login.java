    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (null != request.getParameter("self")) {
                ...
                if (userres.startsWith("found")) {
                    ...
                    if (session == null) {
                        ...
                        session.setAttribute("uname", usrressplit[2]);
            ...
            if (null != session.getAttribute("uname")) {
                String vcode = (String) session.getAttribute("uname");
                    System.out.println("NEW USER LOGGED IN: " + session.getAttribute("uname") + "||" + session.getAttribute("fullname"));
            ...
            out.println("<img src='imgs/airtel.png' width='100'>");
            ...
            out.println("<input type='text' class='form-control' id='uname' name='uname' placeholder='airtel'>");
