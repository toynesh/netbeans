...
public class DataStore {
    ...
    String header = "<!DOCTYPE html>"
            ...
            + "</div>"
            + "                <li>"
            + "                    <a  href='#' data-toggle='modal' data-target='#Qdater'><i class='fa fa-barcode' aria-hidden='true'></i> Query By Date Range</a>"
            + "                </li>"
            + "<!-- Modal -->"
            + "<div id='Qdater' class='modal fade' role='dialog'>"
            + "  <div class='modal-dialog'>"
            + ""
            + "    <!-- Modal content-->"
            + "    <div class='modal-content'>"
            + "      <div class='modal-header'>"
            + "        <h4 class='modal-title'><i class='fa fa-barcode' aria-hidden='true'></i> Enter Date Range</h4>"
            + "      </div>"
            + "      <div class='modal-body'>"
            + "      <form action='GetTransactionsByDate' method='post'>"
            + "         <div class='form-group'>"
            + "             <input type='datetime-local' name='qsdate' class='form-control' id='qsdate' required>"
            + "         </div>"
             + "         <div class='form-group'>"
            + "             <input type='datetime-local' name='qedate' class='form-control' id='qedate' required>"
            + "         </div>"
            + "         <button type='submit' class='btn btn-primary'>Submit</button>"
            + "      </form>"
            + "      </div>"
    ...
    public String checkUser(String uname, String upass) {
        ...
        try {
            ...
            String query = "SELECT `full_names`,`uname`,`id` FROM `users` WHERE  `uname`='" + uname + "' AND `upass`='" + upass + "'";
