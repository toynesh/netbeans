...
public class ClientMain {
    ...
    static public void main(String[] args) throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ClientMain.class.getName()).log(Level.INFO, "enquire_link_resp #1: commandStatus [" + enquireLinkResp1.getCommandStatus() + "=" + enquireLinkResp1.getResultMessage() + "]");
            if (session0 == null) {
            ...
            if (!future0.await()) {
                Logger.getLogger(ClientMain.class.getName()).log(Level.SEVERE, "Failed to receive enquire_link_resp within specified time");
            } else if (future0.isSuccess()) {
                EnquireLinkResp enquireLinkResp2 = (EnquireLinkResp) future0.getResponse();
                Logger.getLogger(ClientMain.class.getName()).log(Level.INFO, "enquire_link_resp #2: commandStatus [" + enquireLinkResp2.getCommandStatus() + "=" + enquireLinkResp2.getResultMessage() + "]");
            } else {
                Logger.getLogger(ClientMain.class.getName()).log(Level.SEVERE, "Failed to properly receive enquire_link_resp: " + future0.getCause());
            }
        } catch (RecoverablePduException ex) {
            java.util.logging.Logger.getLogger(ClientMain.class.getName()).log(Level.SEVERE, null, ex);
        ...
        for (int q = 1; q <= 5; q++) {
            ...
            System.out.println("Submit Res " + submitResp);
            System.out.println("MessageId " + submitResp.getMessageId());
            System.out.println("MessageResult " + submitResp.getResultMessage());
            String[] ressplit = submitResp.toString().split(" ");
            System.out.println("Errorcode " + ressplit[3]);

            java.util.logging.Logger.getLogger(ClientMain.class.getName()).log(Level.INFO, "sendWindow.size: {}" + session0.getSendWindow().getSize());
        }
        System.out.println("Press any key to unbind and close sessions");
        System.in.read();
        session0.unbind(5000);
        if (session0 != null) {
            Logger.getLogger(ClientMain.class.getName()).log(Level.INFO, "Cleaning up session... (final counters)");
            if (session0.hasCounters()) {
                Logger.getLogger(ClientMain.class.getName()).log(Level.INFO, "tx-enquireLink: {}", session0.getCounters().getTxEnquireLink());
                Logger.getLogger(ClientMain.class.getName()).log(Level.INFO, "tx-submitSM: {}", session0.getCounters().getTxSubmitSM());
                Logger.getLogger(ClientMain.class.getName()).log(Level.INFO, "tx-deliverSM: {}", session0.getCounters().getTxDeliverSM());
                Logger.getLogger(ClientMain.class.getName()).log(Level.INFO, "tx-dataSM: {}", session0.getCounters().getTxDataSM());
                Logger.getLogger(ClientMain.class.getName()).log(Level.INFO, "rx-enquireLink: {}", session0.getCounters().getRxEnquireLink());
                Logger.getLogger(ClientMain.class.getName()).log(Level.INFO, "rx-submitSM: {}", session0.getCounters().getRxSubmitSM());
                Logger.getLogger(ClientMain.class.getName()).log(Level.INFO, "rx-deliverSM: {}", session0.getCounters().getRxDeliverSM());
                Logger.getLogger(ClientMain.class.getName()).log(Level.INFO, "rx-dataSM: {}", session0.getCounters().getRxDataSM());
            }
        ...
        Logger.getLogger(ClientMain.class.getName()).log(Level.INFO, "Shutting down client bootstrap and executors...");
        ...
        Logger.getLogger(ClientMain.class
                .getName()
    ...
    public static class ClientSmppSessionHandler extends DefaultSmppSessionHandler {
        ...
        public void firePduRequestExpired(PduRequest pduRequest) {
            Logger.getLogger(ClientMain.class.getName()).log(Level.SEVERE, "PDU request expired: {}", pduRequest);
        }
        ...
        public PduResponse firePduRequestReceived(PduRequest pduRequest) {
            ...
            // do any logic here
            Logger.getLogger(ClientMain.class.getName()).log(Level.INFO, "SMS Received: {}", pduRequest);
            if (pduRequest.getCommandId() == SmppConstants.CMD_ID_DELIVER_SM) {
                ...
                Logger.getLogger(ClientMain.class.getName()).log(Level.INFO, "Inbox: From:" + from + " To:" + dest + " Msg:" + message);
