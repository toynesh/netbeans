...
public class MessageEditor
{
  ...
  public String editToken(String results, String mpesa_acc, String mpesa_msisdn, String mpesa_code, String date)
  {
    ...
    try
    {
      ...
      else if ((str1 + " " + str2).equals("The specified"))
      {
        ...
        String msg = "OK|THE KPLC METER NO " + mtr + " YOU PROVIDED IS NOT CORRECT. Please Contact the Support\nservices for assistance if required. Queries Call:0709711000.";
      ...
      else if ((str1 + " " + str2).equals("Unknown meter"))
      {
        wrd = "wrong meter";
        String mtr = strsplit[3];
        String msg = "OK|THE KPLC METER YOU PROVIDED " + mpesa_acc + " IS NOT CORRECT. Please Contact the Support\nservices for assistance if required. Queries Call:0709711000.";
      ...
      else if ((str1 + " " + str2 + " " + str3).equals("Cannot find meter/account"))
      {
        ...
        String mtr = strsplit[3];
        String msg = "OK|THE KPLC METER NUMBER " + mpesa_acc + " YOU PROVIDED IS NOT CORRECT. Please Contact the Support\nservices for assistance if required. Queries Call:0709711000.";
      ...
      else if ((str1 + " " + str2).equals("The BaseCustomerList"))
      {
        ...
        String mtr = strsplit[3];
        String msg = "OK|THE KPLC METER NUMBER " + mpesa_acc + " YOU PROVIDED HAS MISSING DETAILS. Queries Call:0709711000.";
      ...
      else if ((str1 + " " + str2 + " " + str3).equals("led: Amount requested"))
      {
      ...
      else if ((str1 + " " + str2 + " " + str3).equals("iled: The specified"))
      {
        ...
        String msg = "OK|THE KPLC METER NUMBER YOU PROVIDED IS NOT CORRECT. Please Contact the Support\nservices for assistance if required. Queries Call:0709711000.";
      ...
      else if ((str1 + " " + str2 + " " + str3).equals("iled: The Meter"))
      {
        Logger.getLogger(MessageEditor.class.getName()).log(Level.INFO, "wrong meter on delay");
        wrd = "delay wrong meter";
        String msg = "OK|THE KPLC METER NUMBER YOU PROVIDED " + mpesa_acc + " IS NOT CORRECT. Please Contact the Support\nservices for assistance if required. Queries Call:0709711000.";
      ...
      else if ((str1 + " " + str2).equals("The Meter"))
      {
        ...
        String msg = "OK|The KPLC Meter " + mtr + " is Blocked. For Queries on Meter status Contact 0732170170 or\n0703070707 Queries ph:0709711000.";
      ...
      else if (str.startsWith("MTRFE013"))
      {
        ...
        String msg = "OK|MTRFE013-M1: Your KPLC meter has accumulated a time based charge of " + charge + " You need to\nadd " + inAmt + " to clear the charges or more to receive a token. Queries ph:0709711000.";
  ...
  public static void main(String[] args)
  {
    ...
    String ref = msEObj.editToken(message9, "37150903232", "254728064120", "VendIT", datee);
