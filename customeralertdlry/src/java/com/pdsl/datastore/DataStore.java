...
public class DataStore {
    ...
    public void createTables() {
        ...
        try {
            ...
            String dlr_status= "CREATE TABLE IF NOT EXISTS `blast_dlr_status` (`dlr_id` int(11) NOT NULL AUTO_INCREMENT, `msisdn` varchar(50) DEFAULT NULL, `correlator` varchar(50) DEFAULT NULL, `status` varchar(200) DEFAULT NULL, `dlr_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP, PRIMARY KEY (`dlr_id`))";
    ...
    public void insert(String insert) {
        ...
        try {
            ...
            Logger.getLogger(DataStore.class.getName()).log(Level.SEVERE, "Error Updating Blast Delivery Status" + ex);
        } finally {
        }
