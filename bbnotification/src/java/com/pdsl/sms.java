...
public class sms {
    ...
    public NotifySmsDeliveryReceiptResponse notifySmsDeliveryReceipt(java.lang.String correlator, org.csapi.schema.parlayx.sms.v2_2.DeliveryInformation deliveryStatus) {
        ...
        try {
            ...
            Logger.getLogger(sms.class.getName()).log(Level.INFO, "BREWBISTRO Delivery Value :" + deliveryStatus.getDeliveryStatus());
            Logger.getLogger(sms.class.getName()).log(Level.INFO, "BREWBISTRO Delivery Address :" + deliveryStatus.getAddress());
