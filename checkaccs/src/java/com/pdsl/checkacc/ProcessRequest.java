    ...
    public String _getPostPaidDetailsAcc(String account_no, String client, String term) {
        ...
        if ((details.equals("")) || (details.equals(null)) || (details.equals("ERROR"))) {
            ...
            if (msg.equalsIgnoreCase("Successful")) {
                ...
                String duedate="";
                if (new XML().xmlGetDueDate(details) != "none") {
                    duedate = new XML().xmlGetDueDate(details);
                }
                response = "Owner:" + customer + " Phone:" + phone + " Account:" + account + " Balance: Kshs." + bal + " DueDate:" + duedate;
            } else {
                response = msg;
            }
        }
