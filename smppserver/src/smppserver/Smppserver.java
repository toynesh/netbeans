...
public class Smppserver {
    ...
    static final String copyright
            = "Copyright (c) 2018 Professional Digital Systems Limited\n"
            + "This product includes software developed by PDSL by whom copyright\n"
     ...
     */
    //static String usersFileName = System.getProperty("usersFileName", "/home/coolie/EclipseWSP/smppserver/opensmpp/sim/users.txt");
    static String usersFileName = System.getProperty("usersFileName", "/opt/applications/smppserver/users.txt");
    /**
    ...
    public static void main(String args[]) throws IOException {
        ...
        Smppserver menu = new Smppserver();
        menu.menu();
        //menu.start();
    }
     ...
     * bounding ESMEs. Useful when the user setting is changed or added and
     * restart of the simulator is not possible.
     */
    ...
    protected void sendMessage() throws IOException {
        if (smscListener != null) {
            ...
            int ntms = parseInt(keyboard.readLine());
            for (int t = 1; t <= ntms; t++) {
                try {
                    Thread.sleep(0, 500000);
                } catch (InterruptedException ex) {
                    Logger.getLogger(Smppserver.class.getName()).log(Level.SEVERE, null, ex);
                }
                System.out.print("MO N0;-" + t + " To Client: ");
                            ...
                            for (int i = 0; i < procCount; i++) {
                                ...
                                if (proc.getSystemId().equals(client)) {
                                    if (proc.isActive()) {
                                        ...
                                        String message = "35601211";
                                        DeliverSM request = new DeliverSM();
                                        try {
                                            request.setShortMessage(message);
                                            request.setSourceAddr("254728064120");
                                            request.setDestAddr("20076");
                                            request.setReceiptedMessageId("1234567654321");
