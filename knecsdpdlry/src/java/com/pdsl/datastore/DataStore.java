...
public class DataStore {
    ...
    public void knecInsert(String insert) {
        conn = knecConnect();
        PreparedStatement pstm = null;
        try {
            ...
            Logger.getLogger(DataStore.class.getName()).log(Level.SEVERE, "Error Updating KNEC Delivery Status" + ex);
        } finally {
        }
