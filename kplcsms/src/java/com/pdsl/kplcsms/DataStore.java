...
"            <div class='row'>" +
"                <div class='col-lg-12 '>" +
"                    <span><a href='/kplcsms/Home'><img src='img/kenyapower.png' width='100'></a></span><span class='pull-right' style='margin-top:2%;font-size:30px;color: #ffcf01;'><i class='fas fa-hashtag'></i> BILL ALERTS </span>" +
"                </div>" +
"            </div>            " +
"        </div>" +
