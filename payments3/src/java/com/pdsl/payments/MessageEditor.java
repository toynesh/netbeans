    ...
    public String editToken(String results, String mpesa_acc, String mpesa_msisdn, String mpesa_code, String date) {
        ...
        try {
            if (str.startsWith("token")) {
                ...
                //wrd = "Outta FLOAT!!";
                String msg = "An error occured while processing your Transaction. Queries ph:0709711000";
                wrd = msg;
                ...
                String msg = "FAILED | Your KPLC meter has accumulated a time based charge of " + charge + "; Please retry with an amount higher than  " + charge + "  or call us at 0709711000";
                ...
                String msg = "OK|MTRFE008: Your KPLC meter has a debt due amount. You need to\nadd more to " + inAmt + " to clear the charges or more to receive a token. Queries ph:0709711000.";
